...
from .views import create_product, edit_product, delete_product, product_detail, list_product, create_announcement, edit_announcement, delete_announcement, announcement_detail, list_announcement, search_annoucement
