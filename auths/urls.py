...
from .views import user_address_delete, user_address_update, user_login, profile_register, address_register, edit_profile, reset_password, user_address_register, user_address_list
...
urlpatterns = [
    ...
    path('user_address_delete/<int:id>/', user_address_delete, name='user_address_delete'),
