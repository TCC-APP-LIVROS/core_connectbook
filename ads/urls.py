...
from .views import UploadImageView, announcement_toggle_status, create_announcement_total, create_product, edit_product, delete_product, product_detail, list_product, create_announcement, edit_announcement, delete_announcement, announcement_detail, list_announcement, search_annoucement
...
urlpatterns = [
    ...
    path('announcement/delete/<int:announcement_id>/', delete_announcement, name='delete_announcement'),
    ...
    path('announcement/image/', UploadImageView, name='UploadImageView'),
]